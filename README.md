...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/codewithsamir/Myportfolio.git
...
- Website: [samirrain.com.np](https://samirrain.com.np)
- Email: codewithsamir@gmail.com
- GitHub: [@codewithsamir](https://github.com/codewithsamir)
